...
namespace one {
	...
	public:
		...
		qi::ArrayMap<qi::SPtr<Definition>> definitions, arguments;
		...
		Index( const Index* parent,  const qi::Map<qi::SPtr<Definition>>& definitions ) : parent(parent), caller(0), definitions(definitions) {}
		Index( const Index* parent, const Index* caller, const qi::Map<qi::SPtr<Definition>>& arguments ) : parent(parent), caller(caller), arguments(arguments) {}
		Index( const qi::Map<qi::SPtr<Definition>>& definitions ) : parent(0), caller(0), definitions(definitions) {}
		...
		qi::CSPtr<Definition> findDefinition( const qi::StringBase& name, const Index** body_index = 0 ) const;
		Type findType( const qi::StringBase& name ) const;
	};
}
